  ...
  Gem.add = (module) => {
    ...
    if(code.slice(0,2) == "GE"){
      if(code.slice(2,3) == "S" && Gem.gesMC === 0){
        ...
        Gem.gesMC = Gem.gesMC + parseInt(module.moduleCredit);
        added = true;
      } else if(code.slice(2,3) == "T" && Gem.getMC === 0){
        Gem.pillars.push(module);
        Gem.getMC = Gem.getMC + parseInt(module.moduleCredit);
        added = true;
      } else if(code.slice(2,3) == "R" && Gem.gerMC === 0){
        Gem.pillars.push(module);
        Gem.gerMC = Gem.gerMC + parseInt(module.moduleCredit);
        added = true;
      } else if(code.slice(2,3) == "H" && Gem.gehMC === 0){
        Gem.pillars.push(module);
        Gem.gehMC = Gem.gehMC + parseInt(module.moduleCredit);
        added = true;
      } else if(code.slice(2,3) == "Q" && Gem.geqMC === 0){
        Gem.pillars.push(module);
        Gem.geqMC = Gem.geqMC + parseInt(module.moduleCredit);
        added = true;
      } if(added){
